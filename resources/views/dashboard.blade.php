...
<div class="container">
    ...
    <section class="item para-1">
        <a href="https://hz.nl/uploads/documents/Regelingen/EN/OER-HZ-2019-2020werkdocv2018-05-17DEF_ENGELS-AC-29112019.pdf" target="_" class="nbsa">
        ...
        <div class="table-container">
            <table class="content-table">
                ...
                <tbody>
                <tr >
                    <td class="quartile" rowspan="5">First</td>
                    <td rowspan="2">Programme and Career Orientation</td>
                    <td>2.5</td>
                    <td>Assesment</td>
                    <td>TBA</td>
                </tr>
                ...
                <tr>
                    <td class="quartile" rowspan="4">Forth</td>
                ...
                <tr >
                    <td>Entire Year</td>
                    <td>Personal Professional Dev</td>
                    <td>12.5</td>
                    <td>Portfolio</td>
                    <td>TBA</td>
                </tr>
