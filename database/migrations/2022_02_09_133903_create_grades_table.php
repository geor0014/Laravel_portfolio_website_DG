...
class CreateGradesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('grades', function
        (Blueprint $table) {
            $table->id();
            $table->string('course_name');
            $table->string('test_name');
            $table->decimal('lowest_passing_grade', $precision = 3, $scale = 1)->comment('Lowest grade to pass so average calculations can be applied')->default(5.5);
